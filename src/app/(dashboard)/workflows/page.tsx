...
const WORKFLOWS: Workflow[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "Selecciona 5-7 noticias más relevantes para el nicho de Alex",
  ...
  },
  {
    ...
    steps: [
      ...
      "Evalúa si el trend es relevante para el canal de Alex",
  ...
  },
  {
    ...
    steps: [
      ...
      "Selecciona tema con mayor potencial de engagement para la audiencia de Alex",
      "Redacta post de LinkedIn en la voz de Alex (profesional-cercano, sin emojis ni hashtags)",
  ...
  },
  {
    ...
    description: "Digest curado de las newsletters del día. Consolida lo mejor de las suscripciones de Alex en un resumen accionable.",
  ...
  },
  {
    ...
    description: "Categoriza y resume los emails del día para que Alex empiece la jornada sin inbox anxiety.",
    schedule: "7:45h (cada día)",
    trigger: "cron",
    status: "active",
    steps: [
      ...
      "Detects client emails with pending invoices (>90 days)",
  ...
  },
  {
    ...
    status: "active",
    steps: [
      "Alex envía /cfo, /cmo, /cto, /legal, /growth, /coach o /producto",
      "Bort loads the advisory-board/SKILL.md skill",
      "Lee el archivo de memoria del advisor correspondiente (memory/advisors/)",
      "Responde en la voz y personalidad del advisor con contexto de Alex",
  ...
  },
  {
    ...
    status: "active",
    steps: [
      "Checks for changes in Bort's workspace",
  ...
  },
  {
    ...
    steps: [
      ...
      "Notifica a Alex por Telegram con el resumen de lo implementado",
    ],
  },
];
